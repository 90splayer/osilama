...
const Tools = () => {
  return (
    <div className='w-full pt-16 lg:px-32 px-8 flex-col items-center justify-start space-y-4'>
        ...
        <div className="flex flex-wrap items-center justify-center space-x-8 px-16">
            <div className="w-16 h-16 border rounded-md px-4 pb-1 pt-3 flex flex-col items-center justify-center space-y-2 mb-4">
            ...
            <div className=" lg:w-20 lg:h-20 w-16 h-16 border rounded-md px-4 pb-1 pt-3 flex flex-col items-center justify-center space-y-2 mb-4">
